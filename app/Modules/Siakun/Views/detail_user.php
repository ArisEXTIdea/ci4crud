...
<div id="content-wrapper" class="flex flex-col items-center relative">
    ...
    <div id="header-section" class="py-5 bg-gray-500 w-full">
        <h1 class="text-white text-2xl text-center font-semibold">Detail Pengguna : <?= $userData['full_name'] ?></h1>
    </div>
    ...
    <?php endif;?>
    <div id="user-detail" class="w-11/12 md w-2/3 mt-10 p-10 bg-white rounded-lg border flex flex-col items-center">
        <div id="image" class="w-1/2">
            <img src="/assets/uploads/<?= $userData['image']?>" alt="profil picture" class="w-full">
        </div>
        <div id="account-control" class="mt-10 w-full">
            <a href="/edit-data-user/<?= $userData['uid']?>" class="text-white py-3 px-3 rounded bg-sky-400 hover:bg-sky-500 mr-1">
                <i class="fas fa-edit"></i>
            </a>
            <a href="/edit-data-user-image/<?= $userData['uid']?>" class="text-white py-3 px-3 rounded bg-sky-400 hover:bg-sky-500 mr-1">
                <i class="fas fa-image"></i>
            </a>
            <button onclick="handleModalShow('<?= $userData['uid']?>')" class="text-white py-3 px-3 rounded bg-red-400 hover:bg-red-500 mr-1">
                <i class="fas fa-trash"></i>
            </button>
        </div>
        <div class="w-full mt-10">
            <div class="w-full flex py-5 bg-gray-100 px-5">
                <div class="w-1/3">
            ...
            <div class="w-full flex py-5 bg-gray-200 px-5">
                <div class="w-1/3">
            ...
            <div class="w-full flex py-5 bg-gray-200 px-5">
                <div class="w-1/3">
                    <p class="font-semibold">Henis Kelamin</p>
                </div>
                <div class="w-2/3">
