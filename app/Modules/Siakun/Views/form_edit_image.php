...
<div id="content-wrapper" class="flex flex-col items-center">
    ...
    <div id="page-form" class="w-11/12 md w-2/3 mt-10 p-10 bg-white rounded-lg border">
        <form action="/updateDataImage" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-5 hidden">
                <label for="oldimg" class="font-semibold">Email</label>
                <input type="text" name="oldimg" class="border w-full rounded py-3 px-5 mt-3" placeholder="email@mail.com" value="<?= $userData['image']?>">
            </div>
            <div class="mb-5">
                <label for="image" class="font-semibold">Foto Baru</label>
                <input type="file" name="image" class="border w-full rounded py-3 px-5 mt-3" placeholder="Tuliskan Password Anda!">
            </div>
            <div class="mb-5">
