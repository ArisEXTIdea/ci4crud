    ...
    <div id="page-form" class="w-11/12 md w-2/3 mt-10 p-10 bg-white rounded-lg border">
        <form action="/saveData" method="post" enctype="multipart/form-data">
            <div class="mb-5">
                ...
                <input type="email" name="email" class="border w-full rounded py-3 px-5 mt-3" placeholder="email@mail.com">
            </div>
            <div class="mb-5">
                <label for="password" class="font-semibold">Password</label>
                <input type="password" name="password" class="border w-full rounded py-3 px-5 mt-3" placeholder="Tuliskan Password Anda!">
            </div>
            <div class="mb-5">
                <label for="full_name" class="font-semibold">Nama Lengkap</label>
                <input type="text" name="full_name" class="border w-full rounded py-3 px-5 mt-3" placeholder="John Doe">
            </div>
            <div class="mb-5">
                <label for="address" class="font-semibold">Alamat Tempat Tinggal</label>
                <input type="text" name="address" class="border w-full rounded py-3 px-5 mt-3" placeholder="Jl. Patimura No 101">
            </div>
            <div class="mb-5">
                <label for="gender" class="font-semibold">Jenis Kelamin</label>
                <select name="gender" class="border w-full rounded py-3 px-5 mt-3">
                    <option value="L" selected>Pilih salah satu</option>
            ...
            <div class="mb-5">
                ...
                <input type="file" name="image" class="border w-full rounded py-3 px-5 mt-3">
            </div>
            <div class="mb-5">
